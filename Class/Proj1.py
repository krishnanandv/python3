...
class WOFHumanPlayer(WOFPlayer):
    def getMove(self,category, obscuredPhrase, guessed):
        #stri = input(str(self.name) + "has $"+ str(self.prizeMoney)+ "/n" + ", Category:" + str(category) + "/n" + ", Phrases:" + "/n" + str(obscuredPhrase) + "/n" + ", Guessed:" + str(guessed) + "/n" + "Guess a letter, phrase, or type 'exit' or 'pass':") 
        #print(stri) 
        var="""
        {} has ${}
